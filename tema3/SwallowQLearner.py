...
class SwallowQLearner(object):
    ...
    def learn_from_batch_experience(self, experiences):
        """Actualiza la red profunda con un batch de experiencias previas.
        ...
        td_target = reward_batch + ~done_batch * np.tile(
            self.gamma, len(next_obs_batch)
        ...
        for step in range(STEPS_PER_EPISODE):
            ...
            if done:
                ...
                if total_reward > max_reward:
                    max_reward = total_reward
                print(
                    "\nEpisodio#{} finalizado con {} iteraciones. Recompensa = {}, "
                    "Recompensa media = {}, Mejor recompensa = {}".format(
                        episode,
                        step + 1,
                        total_reward,
